...
public class Board implements Serializable {
  ...
  public void createIngredients() {
    ...
    Ingredient ingredient3 = new Ingredient("feather", 3, alchemyMarker2, "src/ui/utils/ingredient_3.jpg");
    Ingredient ingredient4 = new Ingredient("ginger", 4, alchemyMarker1, "src/ui/utils/ingredient_4.jpg");
    Ingredient ingredient5 = new Ingredient("moondust", 5, alchemyMarker8, "src/ui/utils/ingredient_5.jpg");
    Ingredient ingredient6 = new Ingredient("obsidian", 6, alchemyMarker7, "src/ui/utils/ingredient_6.jpg");
    Ingredient ingredient7 = new Ingredient("redstone", 7, alchemyMarker4, "src/ui/utils/ingredient_7.jpg");
    Ingredient ingredient8 = new Ingredient("saffron", 8, alchemyMarker6, "src/ui/utils/ingredient_8.jpg");
