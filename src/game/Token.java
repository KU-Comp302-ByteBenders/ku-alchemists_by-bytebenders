...
public class Token implements Serializable {
  ...
  public ArrayList<Potion> potionsForFrame;
  private HashMap<Integer, String> deductionBoardIndexCS = new HashMap<Integer, String>();

  // Abstract function is
  // AF(c) = (ingredients, potions, artifactCards, goldBalance, sicknessLevel,
  // avatarImage, tokenImage, username, reputation)
  ...
  public Potion makeExperiment(String ingredient1, String ingredient2, Boolean testOnSelf) {
    ...
    // If the ingredients' color and sign same and size different, the potion is
  ...
  public void testPotion(Potion potion, Boolean testOnSelf) {
    ...
    // EFFECTS: tests the given potion on the token. If the potion is positive, it
    // decreases the token's sickness level by 1.
    // If the potion is negative and test on yourself,
    // it increases the token's sickness level by 1. If it tested on student, you
    // lose 1 gold
  ...
  public void buyArtifactCard(ArtifactCard artifactCard) {
    // EFFECTS: buys the given artifact card and adds it to the token's artifact
    // card list
