...
public class HelpJFrame extends JFrame {
  ...
  public HelpJFrame() {
    ...
    addText(
      mainPanel,
      "● Unique avatars for each player. Track player position, manage resources (ingredients, potions), and record scores.",
      20,
      140
    );
    ...
    addText(
      mainPanel,
      "● Track player hypotheses about ingredient properties. Placed on the Deduction Board to form and test theories.",
      20,
      340
    );
    ...
    addText(
      mainPanel,
      "● Ingredient deck on the board. Allows players to collect ingredients for potion-making.",
      20,
      540
    );
    ...
    addText(
      mainPanel,
      "● Dedicated area to brew potions. Allows players to combine ingredients and brew potions following game rules.",
      20,
      640
    );
    ...
    addText(
      mainPanel,
      "● Displays available Publication Cards and their requirements, and facilitates submitting theories and claiming points.",
      20,
      740
    );
    ...
    addText(
      mainPanel,
      "● Players place alchemy markers to test theories with a user-friendly interface for guessing and confirming.",
      20,
      840
    );
    ...
    addText(
      mainPanel,
      "● When you play this action, discard 1 ingredient and take 1 gold piece from the bank.",
      20,
      1140
    );
    ...
    addText(
      mainPanel,
      "● When you buy an artifact, take one of the cards in the artifact deck and pay 3 golds.",
      20,
      1240
    );
    ...
    addText(
      mainPanel,
      "● You can make experiments where you mix two ingredients and see what happens. You can test your potion on a student or yourself.",
      20,
      1440
    );
    ...
    addText(
      mainPanel,
      "● If you think a published theory is wrong and prove that, you gain 2 points of reputation.",
      20,
      1740
    );
    ...
    addText(
      mainPanel,
      "● In the second round, two more actions are allowed in addition to the actions in the first round:",
      40,
      2060
    );
    ...
    addText(
      mainPanel,
      "● Each reputation point a player has at the end of the game becomes 10 score points in the final score.",
      40,
      2340
    );
    ...
    addText(
      mainPanel,
      "● If a player has any artifact cards left in his/her hand, he/she exchanges each artifact card for 2 gold pieces.",
      40,
      2380
    );
    ...
    addText(
      mainPanel,
      "● The winner of the game is the player with the most score points. Break ties using leftover gold pieces.",
      40,
      2440
    );
